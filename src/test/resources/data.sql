insert into users (email, first_name, last_name, image, password, phone, role)
...
insert into comment (created_at, text, ads_id, users_id)
values ('2023-05-18 14:33:25.661095', 'классный желудь', 2, 1);

insert into photo (dtype, file_path, file_size, media_type, users_id)
values ('Avatar', 'avatar\3c6a9fa9-c9df-45ac-ae65-bff1bfa146a2.jpg', 259009, 'image/jpeg',1);
insert into photo (dtype, file_path, file_size, media_type, ads_id)
